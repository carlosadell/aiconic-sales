...
function stageName(stageId) {
  return BOOKED_STAGES[stageId] || NOSHOW_STAGES[stageId] || RESCHEDULING_STAGES[stageId] || BOOKING_INTERVIEW_STAGES[stageId] || BOOKING_REVIEW_STAGES[stageId] || CANCELLED_STAGES[stageId] || "Other";
}
...
module.exports = { BOOKED_STAGES, NOSHOW_STAGES, CANCELLED_STAGES, RESCHEDULING_STAGES, BOOKING_INTERVIEW_STAGES, BOOKING_REVIEW_STAGES, ALL_STAGES, RULE, stageStatus, stageName, callType, evaluate };
