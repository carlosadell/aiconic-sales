...
function stageName(stageId) {
  return BOOKED_STAGES[stageId] || NOSHOW_STAGES[stageId] || "Other";
}
...
module.exports = { BOOKED_STAGES, NOSHOW_STAGES, ALL_STAGES, RULE, stageStatus, stageName, callType, evaluate };
