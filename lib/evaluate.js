...
const ALL_STAGES = [
  ...
  { id: "ba034c58-d6e0-451e-bb39-7b146322a062", name: "No Show (triggers FUP)" },
  { id: "52d0b1ab-88b1-452b-8966-88e269e9ec75", name: "Booking Interview (triggers FUP)" },
  { id: "fbb75036-ca89-43ee-948a-ed9f60d324f8", name: "Interview Call Booked" },
  { id: "948a6e28-7669-402e-b632-d84b452ebac0", name: "Booking Review" },
  { id: "ae66e02e-8a8a-446d-a26f-85bce067126c", name: "Review Call Booked" },
  { id: "69fd1adb-995d-49cd-90fd-0d2ddac2de2e", name: "🚨 Reschedule (triggers FUP)" },
...
function stageName(stageId) {
  return BOOKED_STAGES[stageId] || NOSHOW_STAGES[stageId] || RESCHEDULING_STAGES[stageId] || BOOKING_INTERVIEW_STAGES[stageId] || BOOKING_REVIEW_STAGES[stageId] || "Other";
}
...
module.exports = { BOOKED_STAGES, NOSHOW_STAGES, RESCHEDULING_STAGES, BOOKING_INTERVIEW_STAGES, BOOKING_REVIEW_STAGES, ALL_STAGES, RULE, stageStatus, stageName, callType, evaluate };
